...
const documentMask = isPersonalUser ? '###.###.###-##' : '##.###.###/####-##'
...
<template>
  <div class="form-group">
    <label class="label" for="document">{{ isPersonalUser ? 'CPF' : 'CNPJ' }}</label>
    <input class="input" type="text" id="document" v-model="model" v-mask="documentMask" />
