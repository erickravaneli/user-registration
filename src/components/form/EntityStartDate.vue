...
<template>
  <div class="form-group">
    <label class="label" for="entity-start-date">{{
      isPersonalUser ? 'Data de nascimento' : 'Data de abertura'
    }}</label>
    <input class="input" type="text" id="entity-start-date" v-model="model" v-mask="'##/##/####'" />
